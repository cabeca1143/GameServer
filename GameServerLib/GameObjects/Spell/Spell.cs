    ...
    public class Spell : IEventSource
    {
        ...
        public void ChannelCancelCheck()
        {
            ...
            if (CastInfo.Targets[0].Unit != null)
            {
                ...
                if (spellTarget != null && (!spellTarget.IsVisibleByTeam(CastInfo.Owner.Team) || (!spellTarget.Status.HasFlag(StatusFlags.Targetable) && !spellTarget.UseableComponent.IsUseable) || spellTarget.IsDead))
